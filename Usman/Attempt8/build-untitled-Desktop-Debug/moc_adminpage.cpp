...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_adminPage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 99, 23)
    },
    "adminPage\0on_createProjectButton_clicked\0"
    "\0on_modifyProjectButton_clicked\0"
    "on_editPrefButton_clicked\0"
...
void adminPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_modifyProjectButton_clicked(); break;
        case 2: _t->on_editPrefButton_clicked(); break;
...
const QMetaObject adminPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_adminPage.data,
      qt_meta_data_adminPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_adminPage.stringdata))
