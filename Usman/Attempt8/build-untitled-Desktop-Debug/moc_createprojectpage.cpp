...
#include "../untitled/createprojectpage.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_createProjectPage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 43, 23)
    ...
    "createProjectPage\0on_cancelButton_clicked\0"
...
const QMetaObject createProjectPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_createProjectPage.data,
      qt_meta_data_createProjectPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_createProjectPage.stringdata))
